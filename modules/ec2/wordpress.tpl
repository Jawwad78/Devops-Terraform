...
apt-get install -y php8.3 libapache2-mod-php8.3 php8.3-mysql php8.3-curl php8.3-xml php8.3-exif php8.3-fileinfo php-igbinary php-imagick php8.3-intl php8.3-mbstring php8.3-zip
